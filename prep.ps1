...
iwr -Uri "https://raw.githubusercontent.com/padrien33/workshop-control-repo/production/workshop_key.enc" -OutFile ~/workshop_key.enc
...
git clone -q git@github.com:padrien33/workshop-control-repo
Write-Host "Done!"
